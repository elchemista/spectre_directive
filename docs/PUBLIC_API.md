# Spectre Directive public API — 0.3.0

This file is the normative public API manifest for Spectre Directive `0.3.0`.
It retains the recoverable `0.1.6` surface while aligning the package and Stack
contracts with Spectre `0.3.0`. Compatibility guarantees apply only to the
